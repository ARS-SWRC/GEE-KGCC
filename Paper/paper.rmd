...
![EE-chart](https://raw.githubusercontent.com/ARS-SWRC/GEE-KGCC/5134298528444570177f7c8085b13b06c5a93de0/Paper/Timeseries.png)
Figure 2: Rates of change in KGCC for 140 year reference period with different RCPs represented; (top) timeline of change in any climate type in the KGCC; (bottom) timeline of expansion for class B climate type. The areas that undergo a change in climate type may be expected to see a corresponding change in ecosystem condition. Areas that transition to a class B climate may be more likely to experience aridification.
