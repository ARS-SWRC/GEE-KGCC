...
Figure 2: Rates of change in KGCC for a 140 year reference period with different RCPs represented; (top) timeline of change in any climate type in the KGCC; (bottom) timeline of expansion for class B climate type. The areas that undergo a change in climate type may be expected to see a corresponding change in ecosystem condition. Areas that transition to a class B climate may be more likely to experience aridification.
