...
This application visualizes U.S. ensemble climate change projections in the NEX-DCP30 dataset. The script can be launched from the online GEE code editor, which results in the same maps and widgets appearing as in the web app. The app features are aimed at enabling the user to do basic analysis for an area of interest and understanding the GCM ensemble and related uncertainties.
